...
class RoleConfigValidateRequestExecutor(
    private val request: RoleConfigValidateRequest
) : RequestExecutor {

    override fun execute(): GoPluginApiResponse {
        val validationResult = MetadataValidator().validate(request.keycloakRoleConfiguration())
