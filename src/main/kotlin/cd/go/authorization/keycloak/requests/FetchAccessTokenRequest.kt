...
class FetchAccessTokenRequest : Request() {
    @Expose
    ...
    override fun executor(): FetchAccessTokenRequestExecutor =
        FetchAccessTokenRequestExecutor(this)

    companion object {
        @JvmStatic
        fun from(apiRequest: GoPluginApiRequest): FetchAccessTokenRequest =
            Request.from(apiRequest, FetchAccessTokenRequest::class.java)
    }
}
