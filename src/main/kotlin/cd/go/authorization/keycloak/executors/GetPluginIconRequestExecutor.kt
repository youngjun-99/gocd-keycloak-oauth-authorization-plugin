...
import cd.go.authorization.keycloak.utils.Util.readResourceBytes
...
class GetPluginIconRequestExecutor : RequestExecutor {
    companion object {
    ...
    private fun getContentType(): String = "image/png"

    private fun getIcon(): String = "/keycloak.png"
}
